...
public class AbelADE {
    ...
    text = text.replaceAll("\\s+", "").toLowerCase(); // Ignorar espacios y mayúsculas
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Diferencia de longitud: " + text.compareTo("Este es un"));
        ...
        System.out.println("¿Es palíndromo? : " + isPalindrome("3343"));
